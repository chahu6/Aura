...
{
	if (!IsValid(MagicCircle) && MagicCircleClass)
	{
...
void AAuraPlayerController::CursorTrace()
{
	...
	const ECollisionChannel TranceChannel = IsValid(MagicCircle) ? ECC_ExcludePlayers : ECC_Visibility;
	GetHitResultUnderCursor(TranceChannel, false, CursorHit);
