...
{
	if (DamageEffectSpaceHandle.Data.IsValid() && DamageEffectSpaceHandle.Data.Get()->GetEffectContext().GetEffectCauser() == OtherActor)
	{
		return;
	}
	...
	if (HasAuthority())
	{
		...
		{
			TargetASC->ApplyGameplayEffectSpecToSelf(*DamageEffectSpaceHandle.Data.Get());
		}
